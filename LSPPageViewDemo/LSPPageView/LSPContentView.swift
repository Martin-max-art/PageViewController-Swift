...
protocol LSPContentViewDelegate : class {
...
class LSPContentView: UIView {
    
    // MARK: 定义属性
    weak var delegate : LSPContentViewDelegate?
...
extension LSPContentView : UICollectionViewDataSource {
...
extension LSPContentView : UICollectionViewDelegate {
...
// MARK:- 遵守LSPTitleViewDelegate协议
extension LSPContentView : LSPTitleViewDeleate {
